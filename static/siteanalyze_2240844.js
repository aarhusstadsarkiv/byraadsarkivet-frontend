if (_sz && _sz.core && _sz.core._isloaded != null) {
  ...
  var _sz = _sz || [];
  _sz.push(["accountid", 2240844]);
  _sz.push(["metagroupname", "document"]);
  _sz.push(["dnt", true]);
  _sz.push(["region", "r1"]);
  var _sz = _sz || [];
  (function(l, b, h, j) {
  ...
  (function(q, a, n, p) {
    ...
    n.analytics = {
      config: {
        ...
        noonclick: false,
        ready: true,
        onClickKey: "szaocHandled" + n.core.rnd(),
      },
      cookie: {
        name: "nmstat",
        domain: f(),
